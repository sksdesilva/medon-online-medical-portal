...
$emg_case1 = $_POST['emg_case1']; //optional one
$emg_case2 = $_POST['emg_case2']; //optional one
$emg_case3 = $_POST['emg_case3']; //optional one
$emg_cases = $_POST['emg_cases']; //optional one
...
if($con->query($sql)){
    echo '<center>'."Registered succsesfully".'</center>';
    echo '<center>'.'<a href="../php/patient_login.php">CLICK TO LOGIN</a>'.'</center>';
}
else{
